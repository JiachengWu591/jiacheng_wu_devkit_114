# -*- coding: utf-8 -*-
#
# jiacheng_wu_devkit_114 documentation build configuration file, created by
...
package_name = "jiacheng_wu_devkit_114"
...
# Add data for Jinja2
try:
    from jiacheng_wu_devkit_114.docs import doc_data
except:
    doc_data = dict()
